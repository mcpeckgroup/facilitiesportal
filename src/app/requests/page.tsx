...
export default function RequestsPage() {
    ...
    return (
      <main className="max-w-4xl mx-auto p-6">
        ...
        <p className="text-gray-700">
          Please <Link className="text-blue-600 underline" href="/login">log in</Link> to view and manage requests.
        </p>
      </main>
    );
  }
  ...
  return (
    <main className="max-w-6xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold">Open & In-Progress Requests</h1>
        <div className="flex gap-3">
          <Link className="px-3 py-2 rounded bg-blue-600 text-white" href="/requests/new">
            New Request
          </Link>
              ...
              {list.length === 0 && (
                <tr>
                  <td className="p-4 text-gray-600" colSpan={6}>
                    No open or in-progress requests.
                  </td>
                </tr>
              )}
            </tbody>
